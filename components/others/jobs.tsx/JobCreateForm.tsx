                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <Input id="location" placeholder="Enter the location" name="location" />
                            </div>
                            <div className="space-y-2">
                            ...
                            <div className="space-y-2">
                                ...
                                <Input id="startDate" placeholder="Start Date" name="startDate" type="date" />
                            </div>
                            <div className="space-y-2">
                                <Label htmlFor="endDate">End Date</Label>
                                <Input id="endDate" placeholder="End Date" name="endDate" type="date" />
                            </div>
                            <div className="space-y-2">
