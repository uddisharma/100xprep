                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <Input defaultValue={job?.company} id="company" name="company" placeholder="Company Name" />
                            </div>
                            <div className="space-y-2">
                            ...
                            <div className="space-y-2">
                                ...
                                <Input defaultValue={job?.location} id="location" placeholder="Enter the location" name="location" />
                            </div>
                            <div className="space-y-2">
                                <Label htmlFor="salary">Salary</Label>
                                <Input defaultValue={job?.salary} id="salary" placeholder="Salary" name="salary" />
                            </div>
                            <div className="space-y-2">
                                <Label htmlFor="startDate">Start Date</Label>
                                <Input defaultValue={job?.startDate?.toISOString().split('T')[0]} id="startDate" placeholder="Start Date" name="startDate" type="date" />
                            </div>
                            <div className="space-y-2">
                                <Label htmlFor="endDate">End Date</Label>
                                <Input defaultValue={job?.endDate?.toISOString().split('T')[0]} id="endDate" placeholder="End Date" name="endDate" type="date" />
                            </div>
                            <div className="space-y-2">
                                <Label htmlFor="link">Apply Link</Label>
                                <Input defaultValue={job?.link} id="link" placeholder="Apply Link" name="link" />
                            </div>
