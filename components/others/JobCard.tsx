...
const JobCard = ({ job }: { job: JobType }) => {
  return (
    ...
    >
      <div
        className={`inline-flex h-full w-full animate-shimmer items-center justify-between  bg-[linear-gradient(110deg,#333_0.6%,#222)] p-4  max-h-[20rem] rounded-xl border border-[#eaeaea] dark:border-[#71717a] `}
      >
        <div>
          <div className="text-black dark:text-white font-bold text-[16px] mb-1">
            {job?.title}
          </div>
        ...
        <div className="flex flex-col items-end">
          ...
          <div className="text-[#71717a] text-[14px] mt-5">
            -
            {daysUntil(
              job?.endDate
