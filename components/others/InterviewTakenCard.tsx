...
const InterviewTaken = () => {
  return (
    <Link href="/dashboard/interviews/view">
      <div
        className={`inline-flex h-full w-full animate-shimmer items-center justify-between  bg-[linear-gradient(110deg,#333_0.6%,#222)] p-4  max-h-[20rem] rounded-xl border border-[#eaeaea] dark:border-[#71717a] cursor-pointer mt-5`}
      >
        <div>
