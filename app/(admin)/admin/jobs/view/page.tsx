    ...
    <div className="h-full w-full ">
      <div className="h-full rounded-md flex flex-col items-left justify-center relative  mx-auto py-10 md:py-0 p-6  overflow-y-scroll w-full mb-10">
        <Spotlight
          ...
          fill="white"
        />
        <h1 className="w-full text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 mt-[400px] lg:mt-10">
          {job?.title}
        </h1>
        <div className="rounded-lg mt-5">
          <p className="text-white mb-4 flex gap-2 items-center">
            {" "}
            <IconBuilding className="h-4 w-4 text-neutral-800 dark:text-neutral-300" />
            {job?.company}
          </p>

          <p className="text-white mb-4 flex gap-2 items-center">
            {" "}
            <IconMapPin className="h-4 w-4 text-neutral-800 dark:text-neutral-300" />
            {job?.location}
          </p>
          <p className="text-white mb-4 flex gap-2 items-center">
            {" "}
            <IconCash className="h-4 w-4 text-neutral-800 dark:text-neutral-300" />
            {job?.salary}
          </p>
