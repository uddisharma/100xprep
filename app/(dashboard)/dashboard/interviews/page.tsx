...
const InterviewsGiven = dynamic(
  () => import("@/components/others/interview/Given"),
  { ssr: true },
);
const InterviewsTaken = dynamic(
  () => import("@/components/others/interview/Taken"),
  { ssr: true },
);
    ...
    <div className="flex flex-1">
      <div className="p-2 md:p-10 rounded-tl-2xl border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 flex flex-col gap-5 flex-1 w-full h-full overflow-y-scroll max-h-[100vh] ">
        ...
        <div className="w-full flex justify-between flex-wrap items-center">
          <Cover>
            <GlowingStarsTitle>Your Past Interviews</GlowingStarsTitle>
